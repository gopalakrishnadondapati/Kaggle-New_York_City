...
traindata <- as.tibble(fread("E:\\Kaggle\\New.York.City.Taxi.Trip.Duration\\train.csv"))
testdata <- as.tibble(fread("E:\\Kaggle\\New.York.City.Taxi.Trip.Duration\\test.csv"))
